...
export class AddPage implements OnInit, AfterViewInit {
  ...
  @ViewChild("searchTypeSelect", { static: false })
  searchTypeSelect!: IonSelect;
  ...
  @ViewChild("amazonmusic_title", { static: false })
  amazonmusicTitle!: IonInput;
  @ViewChild("amazonmusic_cover", { static: false })
  amazonmusicCover!: IonInput;
  @ViewChild("applemusic_artist", { static: false })
  applemusicArtist!: IonInput;
